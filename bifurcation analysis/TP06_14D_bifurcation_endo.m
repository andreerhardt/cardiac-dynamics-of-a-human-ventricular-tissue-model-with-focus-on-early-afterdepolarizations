...
if endo_case == 1
    scaleKr  = 0.1; 
    scaleCaL = 5;
    name = 'TP06_14D_endo_case_1';
elseif endo_case == 2
    scaleKr  = 0.5; 
    scaleCaL = 6;
    name = 'TP06_14D_endo_case_2';
end
g_Kr    = 0.153*scaleKr;
...
[x0,v0] = init_EP_EP(@TP06_endo_14d_bif,xinit,p_bif,ap);
...
[x0,v0]   = init_H_LC(@TP06_endo_14d_bif,xinit,p_bif,ap,h,ntst,ncol);
