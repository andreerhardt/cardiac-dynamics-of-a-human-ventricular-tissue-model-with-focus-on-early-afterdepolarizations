...
%% parameters
    ...
    elseif cases == 'M'
        ...
        [t_M1,y_M1]     = ode15s(@fun_modified_TP06_epi_M_endo_16d,tspan,y0,opts,g_Kr,g_Ks,g_Na,g_K1,g_CaL,K_i,89,choice);
        [t_M2,y_M2]     = ode15s(@fun_modified_TP06_epi_M_endo_14d,tspan,y0_,opts,g_Kr,g_Ks,g_Na,g_K1,g_CaL,K_i,95,choice);
...
L2 = legend(ah1,[h,h3],'16 dimensional model with $\mathrm{I}_\mathrm{stim} = 89 \frac{pA}{pF}$','14 dimensional model with $\mathrm{I}_\mathrm{stim} = 95 \frac{pA}{pF}$');
